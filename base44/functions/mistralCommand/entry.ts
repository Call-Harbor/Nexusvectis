...
- "lav en rapport om flåden" → action: CREATE_DOCUMENT, parameters: {title: "Fleet Performance Report", content_html: "<h1>Fleet Performance Report</h1><h2>Executive Summary</h2><p>...</p>...", description: "Fleet performance report generated by FLEET AI"}
- "opret et budget regneark" → action: CREATE_SPREADSHEET, parameters: {title: "Budget Tracker", grid: [["Category","Budget","Actual","Variance"],["Fuel","50000","48000","2000"]], description: "Budget tracker spreadsheet"}
- "skriv et dokument om..." → action: CREATE_DOCUMENT with full rich HTML content
- "lav et regneark med..." → action: CREATE_SPREADSHEET with full data grid
- "predict vehicle maintenance" → action: SHOW_ANALYSIS, parameters: {chart_data: [{vehicle: "Truck-1", failure_risk: 75, brake_wear: 82, oil_degradation: 61, tire_depth: 45, engine_temp: 38},{vehicle: "Truck-2", failure_risk: 45, brake_wear: 50, oil_degradation: 30, tire_depth: 70, engine_temp: 22},{vehicle: "Ship-A", failure_risk: 88, brake_wear: 90, oil_degradation: 75, tire_depth: 55, engine_temp: 65},{vehicle: "Truck-3", failure_risk: 32, brake_wear: 28, oil_degradation: 20, tire_depth: 85, engine_temp: 18},{vehicle: "Drone-1", failure_risk: 55, brake_wear: 60, oil_degradation: 40, tire_depth: 50, engine_temp: 30},{vehicle: "Train-A", failure_risk: 20, brake_wear: 15, oil_degradation: 10, tire_depth: 90, engine_temp: 12},{vehicle: "Truck-4", failure_risk: 67, brake_wear: 72, oil_degradation: 55, tire_depth: 48, engine_temp: 42},{vehicle: "Aircraft-1", failure_risk: 41, brake_wear: 44, oil_degradation: 38, tire_depth: 62, engine_temp: 25}], chart_config: {type: "bar", title: "Predictive Maintenance Analysis", xKey: "vehicle", bars: [{key: "failure_risk", name: "Failure Risk %"},{key: "brake_wear", name: "Brake Wear %"},{key: "oil_degradation", name: "Oil Degradation %"},{key: "tire_depth", name: "Tire Remaining %"}], summary: "Fleet maintenance analysis reveals 3 vehicles in critical risk zone...", insights: [{text: "Ship-A requires immediate engine inspection — 88% failure risk detected", severity: "critical", impact: "Potential 72h downtime = €18,400 revenue at risk"},{text: "Truck-1 brake pads need replacement within 14 days", severity: "high", impact: "Safety risk + €3,200 repair if delayed to failure"},{text: "Truck-4 oil degradation exceeds 55% — schedule service", severity: "medium", impact: "Engine longevity reduced by 15% without intervention"}], recommendations: [{action: "Emergency inspection for Ship-A engine systems", savings_dkk: 138000, timeframe: "30d", confidence: 0.92},{action: "Batch brake service for Truck-1, Truck-4 simultaneously", savings_dkk: 24000, timeframe: "30d", confidence: 0.87}]}}
- "forecast shipment demand" → action: SHOW_ANALYSIS, parameters: {chart_data: [{month: "Jan", predicted: 380, actual: 362, baseline: 340, optimistic: 410},{month: "Feb", predicted: 410, actual: 398, baseline: 370, optimistic: 445},{month: "Mar", predicted: 450, actual: 420, baseline: 400, optimistic: 490},{month: "Apr", predicted: 495, actual: null, baseline: 430, optimistic: 540},{month: "May", predicted: 545, actual: null, baseline: 460, optimistic: 600},{month: "Jun", predicted: 580, actual: null, baseline: 490, optimistic: 640},{month: "Jul", predicted: 520, actual: null, baseline: 450, optimistic: 575},{month: "Aug", predicted: 510, actual: null, baseline: 445, optimistic: 560}], chart_config: {type: "line", title: "90-Day Demand Forecast", xKey: "month", lines: [{key: "predicted", name: "AI Forecast"},{key: "actual", name: "Actual"},{key: "baseline", name: "Baseline"},{key: "optimistic", name: "Optimistic Scenario"}], summary: "AI demand forecasting identifies 15% growth trajectory into Q2...", insights: [{text: "Peak demand window identified: May–June, 21% above baseline", severity: "high", impact: "Pre-position 3 additional vehicles to capture €67,000 revenue"},{text: "January–March forecast accuracy: 94.2% — model performing well", severity: "low", impact: "High confidence in Q2 projections"},{text: "August seasonal dip likely — plan driver vacations during this window", severity: "medium", impact: "Save €12,000 in overtime costs"}], forecasts: [{name: "Q2 Total Demand", value: "1,620 shipments", timeframe: "90d", confidence: 87, scenario: "optimistic"},{name: "Annual Growth Rate", value: "+18.4%", timeframe: "90d", confidence: 79, scenario: "baseline"}]}}
- "CO2 emissions report" → action: SHOW_ANALYSIS, parameters: {chart_data: [{name: "Copenhagen–Hamburg (Truck)", value: 850, potential: 340, saving: 510},{name: "Rotterdam–Oslo (Ship)", value: 1240, potential: 620, saving: 620},{name: "London–Paris (Train)", value: 180, potential: 120, saving: 60},{name: "Frankfurt–Warsaw (Air)", value: 3200, potential: 1800, saving: 1400},{name: "Gdansk–Stockholm (Ship)", value: 960, potential: 480, saving: 480},{name: "Hamburg–Munich (Rail)", value: 210, potential: 140, saving: 70}], chart_config: {type: "bar", title: "CO2 Emissions by Route — Actual vs Potential", xKey: "name", bars: [{key: "value", name: "Current CO2 (kg)"},{key: "potential", name: "Optimized CO2 (kg)"},{key: "saving", name: "Reduction Potential (kg)"}], summary: "Fleet CO2 analysis reveals 42% reduction potential through modal shift...", insights: [{text: "Frankfurt–Warsaw air route emits 17x more CO2 than rail alternative", severity: "critical", impact: "Switching to rail saves 1,400 kg CO2 per trip = €8,400/year in EU ETS costs"},{text: "Maritime routes Rotterdam–Oslo and Gdansk–Stockholm carry largest absolute reduction potential", severity: "high", impact: "Combined 1,100 kg/trip reduction achievable via slow steaming + route optimization"}]}}
