        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li><Link to={createPageUrl("About")} className="hover:text-fuchsia-400 transition-colors">About</Link></li>
          ...
          <div className="h-px bg-gradient-to-r from-transparent via-fuchsia-500/50 to-transparent mb-8" />
