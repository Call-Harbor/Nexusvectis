...
import { Zap, Code, Plug, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="pt-40 pb-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <Plug className="w-20 h-20 text-fuchsia-400 mx-auto mb-8" />
          <h1 className="text-7xl font-black text-white mb-8">
            <span className="text-fuchsia-400">Integrations</span>
          </h1>
          <p className="text-2xl text-slate-300 mb-12 max-w-3xl mx-auto">
            Connect NexusVectis with your existing systems. REST API, webhooks, and pre-built connectors.
          </p>
        </div>
      </section>

      <section className="py-32 px-6 bg-gradient-to-b from-transparent to-fuchsia-950/10">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Code, title: "REST API", desc: "Full-featured API for custom integrations" },
              { icon: Zap, title: "Webhooks", desc: "Real-time event notifications" },
              { icon: Plug, title: "Pre-built Connectors", desc: "ERP, WMS, TMS integrations" }
            ].map((feature, idx) => {
              ...
              return (
                ...
                >
                  <Icon className="w-12 h-12 text-fuchsia-400 mb-6" />
