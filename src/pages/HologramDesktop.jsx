...
export default function HologramDesktop() {
  ...
  return (
    ...
    >
      ...
      {/* Live Alerts */}
      {activeWidgets.includes('alerts') && <HoloWidget title="Live Alerts" icon={Bell} color="red" id="alerts" defaultPos={getWidgetPosition('alerts', screenIndex)} screenIndex={screenIndex} onSendToScreen={handleSendToScreen} onClose={() => setActiveWidgets(p => p.filter(w => w !== 'alerts'))}>
      ...
      {/* Shipment Tracker */}
      {activeWidgets.includes('shipments') && <HoloWidget title="Shipment Tracker" icon={Package} color="emerald" id="shipments" defaultPos={getWidgetPosition('shipments', screenIndex)} screenIndex={screenIndex} onSendToScreen={handleSendToScreen} onClose={() => setActiveWidgets(p => p.filter(w => w !== 'shipments'))}>
        <div className="space-y-2 min-w-[240px]">
          {[
      ...
      {activeWidgets.includes('trend') && <HoloWidget title="Delivery Trend (7d)" icon={TrendingUp} color="violet" id="trend" defaultPos={getWidgetPosition('trend', screenIndex)} screenIndex={screenIndex} onSendToScreen={handleSendToScreen} onClose={() => setActiveWidgets(p => p.filter(w => w !== 'trend'))}>
      ...
      {/* Live Map */}
      {activeWidgets.includes('map') && <HoloWidget title="Live Fleet Map" icon={Globe} color="blue" id="map" defaultPos={getWidgetPosition('map', screenIndex)} screenIndex={screenIndex} onSendToScreen={handleSendToScreen} onClose={() => setActiveWidgets(p => p.filter(w => w !== 'map'))}>
