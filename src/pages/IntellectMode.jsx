  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 h-screen flex flex-col">
        ...
        {/* Command Interface */}
        <div className="p-3 sm:p-4 lg:p-6 backdrop-blur-xl bg-[linear-gradient(rgba(6,182,212,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(6,182,212,0.08)_1px,transparent_1px)] bg-[size:50px_50px]">
