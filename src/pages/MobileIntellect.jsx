    ...
    <div className="h-screen bg-slate-950 text-white flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800 bg-slate-900/50 backdrop-blur">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm">FLEET AI Mobile</span>
        </div>
        <button 
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-14 right-4 bg-slate-800 border border-slate-700 rounded-lg shadow-lg z-50 w-48 overflow-hidden"
          >
            <div className="p-2 space-y-1">
              <button className="w-full text-left px-3 py-2 hover:bg-slate-700 rounded text-sm flex items-center gap-2">
