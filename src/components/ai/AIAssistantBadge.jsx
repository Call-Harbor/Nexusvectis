        ...
        {isOpen && (
          ...
          >
            ...
            <p className="text-xs text-slate-400 mb-3">
              I'm analyzing your fleet in real-time. Check the insights on each page for optimization recommendations.
            </p>
            <div className="text-xs text-slate-500 space-y-1">
              <p>💡 Route optimization insights</p>
              <p>📊 Vehicle efficiency analysis</p>
              <p>⚠️ Predictive maintenance alerts</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
