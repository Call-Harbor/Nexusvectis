  ...
  const kpis = [
    {
      label: "ON-TIME PERF",
      value: `${metrics.otp}%`,
      sub: `${metrics.otp >= 80 ? "▲ NORM" : metrics.otp >= 60 ? "▼ LAV" : "⚠ KRITISK"}`,
    ...
    },
    {
      ...
      sub: `${metrics.openLanes}/${metrics.totalLanes} baner åbne`,
    ...
    },
    {
      ...
      sub: `${metrics.totalGates > 0 ? Math.round((metrics.activeGates / Math.max(metrics.totalGates,1)) * 100) : 0}% belægning`,
      color: "#06b6d4",
    ...
    },
    {
      ...
      sub: `${metrics.totalFlights} fly i alt`,
    ...
    },
    {
      ...
      sub: `${metrics.delayedTasks} forsinkede`,
    ...
    },
    {
      ...
      sub: metrics.criticalFlights > 0 ? "KRÆVER HANDLING" : "ALT NORMALT",
    ...
    },
    {
      ...
      sub: `af ${metrics.totalStaff} på vagt`,
    ...
    },
    {
      ...
      sub: metrics.missedBags > 0 ? "OFFLOADED/MANGLER" : "OK",
