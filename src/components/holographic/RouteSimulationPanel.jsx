...
Give a 2-sentence expert logistics recommendation to reduce fuel and CO₂. Be concise and specific.`,
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col bg-slate-950/97 border border-cyan-400/40 rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(6,182,212,0.15)] max-h-[92vh]">
        {/* Scan line */}
        <motion.div
              ...
              <AnimatePresence>
                {simDone && metrics && (
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                    ...
                    >
                      <RefreshCw className="w-3 h-3" /> Re-simuler
                    </button>
                  </motion.div>
                )}
              </AnimatePresence>
