...
function buildZip(fileMap) {
  ...
  for (const [name, content] of Object.entries(fileMap)) {
    ...
    const local = concat(new Uint8Array([0x50,0x4b,0x03,0x04]), u16(20), u16(0), u16(0), u16(0), u16(0), u32(crc), u32(dataBytes.length), u32(dataBytes.length), u16(nameBytes.length), u16(0), nameBytes, dataBytes);
    const central = concat(new Uint8Array([0x50,0x4b,0x01,0x02]), u16(20), u16(20), u16(0), u16(0), u16(0), u16(0), u16(0), u32(crc), u32(dataBytes.length), u32(dataBytes.length), u16(nameBytes.length), u16(0), u16(0), u16(0), u16(0), u32(0), u32(offset), nameBytes);
    localHeaders.push(local); centralDir.push(central); offset += local.length;
  }
  const centralBlob = concat(...centralDir);
  const eocd = concat(new Uint8Array([0x50,0x4b,0x05,0x06]), u16(0), u16(0), u16(centralDir.length), u16(centralDir.length), u32(centralBlob.length), u32(offset), u16(0));
