        ...
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="bg-slate-900 border-slate-800 max-h-96 overflow-y-auto">
              ...
              {[['nexus_chat', MessageSquare, 'Chat'], ['video_call', Video, 'Video Call'], ['document_editor', FileText, 'Document Editor'], ['spreadsheet_editor', BarChart3, 'Spreadsheet'], ['web_browser', Globe, 'Web Browser']].map(([type, Icon, label]) => (
